export default {
  ...
  'menu.enterprise.entry-audit': '企業入駐審核',
  'menu.enterprise.change-audit': '企業變更審核',
  'menu.enterprise.list': '企業列表',
  'menu.membership': '會員管理',
  'menu.membership.plans': '會員方案',
  'menu.membership.list': '會員列表',
};
