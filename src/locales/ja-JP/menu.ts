export default {
  ...
  'menu.enterprise': '企業管理',
  'menu.enterprise.entry-audit': '企業の入居審査',
  'menu.enterprise.change-audit': '企業変更審査',
  'menu.enterprise.list': '企業リスト',
  'menu.membership': '会員管理',
  'menu.membership.plans': '会員プラン',
  'menu.membership.list': '会員リスト',
};
