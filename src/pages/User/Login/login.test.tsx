...
describe('Login Page', () => {
  ...
  it('should show login form', async () => {
    ...
    await rootContainer.findAllByText('非线数联');
    ...
    expect(rootContainer.baseElement?.querySelector('.ant-pro-form-login-desc')?.textContent).toBe(
      '非线数联 is the most influential web design specification in Xihu district',
    );
  ...
  it('should login success', async () => {
    ...
    await rootContainer.findAllByText('非线数联 Pro');
